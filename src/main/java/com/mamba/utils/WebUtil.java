...
public class WebUtil {
     ...
     */
    public static final String getCookieValue(final HttpServletRequest request, final String cookieName,
    ...
    public static String getHost(final HttpServletRequest request) {
        String ip = request.getHeader("X-Forwarded-For");
        if (StrUtil.isBlank(ip) || REQUEST_UNKNOWN_IP.equalsIgnoreCase(ip)) {
            ip = request.getHeader("Proxy-Client-IP");
        }
        if (StrUtil.isBlank(ip) || REQUEST_UNKNOWN_IP.equalsIgnoreCase(ip)) {
            ip = request.getHeader("WL-Proxy-Client-IP");
     ...
     * 写出响应
     */
    public static boolean write(final HttpServletResponse response, final String code, final String description)
        throws IOException {
        response.setContentType("application/json;charset=UTF-8");
        final Map<String, Object> result = MapUtil.newHashMap();
     ...
     * 写出响应
     */
    public static void write(final HttpServletResponse response, final Map<String, Object> modelMap)
        throws IOException {
        response.setContentType("application/json;charset=UTF-8");

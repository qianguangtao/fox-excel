 ...
 */
public class EnumDeserializer extends JsonDeserializer<Enum<? extends EnumDefinition>>
    ...
    @Override
    public Enum<? extends EnumDefinition> deserialize(JsonParser jsonParser,
